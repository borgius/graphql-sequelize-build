...
function sequelizeConnection(_ref2) {
  ...
  let buildFindOptions = function buildFindOptions() {
    ...
    _lodash2.default.assignWith(options, args.orderBy.reduce(function (result, orderBy) {
      ...
      return _lodash2.default.assignWith(result, orderAssociations.reduce(function (_ref4, associationName, index) {
        let order = _ref4.order,
  ...
  let $resolver = (0, _resolver2.default)(target, {
    ...
    after: (() => {
      var _ref5 = (0, _bluebird.coroutine)(function* (values, args, context, info) {
        //build: handleResult
