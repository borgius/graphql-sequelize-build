...
function sequelizeConnection(_ref2) {
  ...
  let orderByType = _ref2.orderBy;
  let _before = _ref2.before;
  let handleResult = _ref2.handleResult;
  ...
  let argsToWhereWithIncludeAssociations = function argsToWhereWithIncludeAssociations(args) {
    const result = {
      where: {},
      include: []
    };
  ...
  let buildFindOptions = function buildFindOptions() {
    ...
    _lodash2.default.assignWith(options, args.orderBy.reduce(function (result, orderBy) {
      ...
      return _lodash2.default.assignWith(result, orderAssociations.reduce(function (_ref3, associationName, index) {
        let order = _ref3.order;
        let include = _ref3.include;
    ...
    //build: argsToWhereWithIncludeAssociations
    _lodash2.default.assignWith(options, argsToWhereWithIncludeAssociations(args), (a, b) => Array.isArray(a) ? a.concat(b) : b);
    ...
    after: (() => {
      var _ref4 = (0, _bluebird.coroutine)(function* (values, args, context, info) {
        ...
        if ((args.first || args.last) && (fullCount === null || fullCount === undefined)) {
          ...
          fullCount = yield model.count(context.findOptions);
        }
