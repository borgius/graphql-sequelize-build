...
exports.sequelizeConnection = exports.sequelizeNodeInterface = exports.NodeTypeMapper = undefined;
...
function createConnectionResolver({
  ...
  let fromCursor = function (cursor) {
    let [id, index] = JSON.parse((0, _base.unbase64)(cursor));
  ...
  let $resolver = (0, _resolver2.default)(targetMaybeThunk, {
    include,
  ...
  let resolveConnection = (source, args, context, info) => {
    ...
    return after(_extends({
      source,
      args
    }, buildFindOptions({}, args, context, info)), args, context, info);
  };
